function [ fid, dFid_j_k ] = bgrape_calc_fid_grad_gridrfmw_uni( opt_params, control_fields )
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[fid_temp, dFid_j_k_temp] = grape.bgrape_calc_fid_grad_uni(opt_params, control_fields);
fid = fid + fid_temp;
